...
'@
$r = Rpc 'tools/call' @{ name = 'send_code_to_revit'; arguments = @{ code = $code; transactionMode = 'none' } }
$t = ToolText $r
...
$r = Rpc 'tools/call' @{ name = 'send_code_to_revit'; arguments = @{ code = 'this is not valid C#;'; transactionMode = 'none' } }
$t = ToolText $r
